...
<head>
    ...
    <title>Too-Dufufufu-- Level up your productivity</title>
</head>
                ...
                <section class=" create-task">
                    ...
                    <form action="" method="post" id="form-group">
                        <div class="form-grouper">
                            ...
                            <input type="text" id="task--title" name="title" placeholder="Enter task title accurately">
                        </div>

                        <div class="form-grouper">
                            <label for="task--description">Task Description</label>
                            <textarea id="task--description" name="description"
                                placeholder="Enter task description accurately"></textarea>
                        </div>
                        ...
                        <div class="form-grouper">
                            ...
                            <select id="task--priority" name="priority">
                                <option value="Low" selected hidden>Select Task Priority</option>
